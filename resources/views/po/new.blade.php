  ...
  <head>
    ...
    <title>New PO Page</title>
        ...
        <div class="row no-gutters mt-5">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="http://localhost/admin/admin"><i class="fas fa-user-cog mr-2"></i> Admin</a><hr class="bg-secondary">
            </li>
            <li class="nav-item">
            ...
            <div class="col-md-10 p-5 mt-2">
                <h1><i class="fas fa-file-invoice-dollar m-2"></i>New Transaction</h1><hr>
