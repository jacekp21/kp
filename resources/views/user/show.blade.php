                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if ($user->status == 'active')
                                    ...
                                    <a href="/user/disable/{{ $user->id }}" class="btn btn-danger" onclick ="if (!confirm('Anda Yakin? Aksi ini tidak dapat dikembalikan lagi!')) return false;">
                                        <i class="fas fa-ban"></i> Void 
                                    </a>
                                @else
                                    <a href="/user/show/{{ $user->id }}" class="btn btn-success">
