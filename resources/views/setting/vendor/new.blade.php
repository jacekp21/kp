  ...
  <li class="breadcrumb-item"><a href="http://localhost:8000/dashboard">Home</a></li>
    ...
    <li class="breadcrumb-item active" aria-current="page">New</a></li>
        ...
        <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="namavendor" placeholder="">
        <div class="mb-3">
        ...
        <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="cabang" placeholder="">
        <div class="mb-3">
                    <label for="namarek" class="form-label">Nama Rekening</label>
                    <input type="text" class="form-control" id="namarek" placeholder="">
